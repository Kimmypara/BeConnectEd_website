...
<div class="col">
    <div class="offcanvas-body">
        <ul class="nav flex-column">
           <li class="nav-item">
  <a class="nav-link <?php if ($currentPage == 'home_admin.php') echo 'active'; ?>" href="home_admin.php">
      Home
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link <?php if ($currentPage == 'attendance_admin.php') echo 'active'; ?>" href="attendance_admin.php">
      Attendance
  </a>
</li>
