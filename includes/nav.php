...
echo '&nbsp;' . htmlspecialchars(trim($first . ' ' . $last));
    ...
    ?>
      ...
      <div class="col-1 " >
    <a href="" id="theme-switch" alt="dark or light mode button">
<svg alt="dark mode button" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="var(--text-color )" class="bi bi-moon-stars   dark-mode-icon " viewBox="0 0 16 16">
...
<svg alt="light mode button" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="var(--text-color )" class="bi bi-brightness-high  light-mode-icon" viewBox="0 0 16 16">
...
<script src="includes/card_list.js" type="text/javascript" defer></script>
