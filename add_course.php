  ...
  <?php 
        if(isset($_GET["error"])) { 
            ...
            if (isset($_GET["invalidCourse_name"])){
                $error = $error."<li>Course name format invalid.</li>";
            }

             if (isset($_GET["invalidCourse_code"])){
                $error = $error."<li>Course code format invalid.</li>";
            }
            if (isset($_GET["courseCodeExists"])) {
             $error .= "<li>Course code already exists.</li>";
            }

            if (isset($_GET["invalidMQF_Level"])){
                $error = $error."<li>MQF Level format invalid.</li>";
            }
            if (isset($_GET["invalidCredits"])){
                $error = $error."<li>Credits format invalid.</li>";
            }
            if (isset($_GET["invalidDuration"])){
                $error = $error."<li>Duration format invalid.</li>";
            }
